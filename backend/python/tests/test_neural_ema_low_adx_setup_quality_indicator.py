...
from backend.python.lib.indicator.features.neural_ema_low_adx_setup_quality_v4_bg020 import (
...
def make_symbol(rows):
    ...
    return Symbol('TEST', 'M5', len(candles), candles=candles)


class NeuralEmaLowAdxSetupQualityIndicatorTest(unittest.TestCase):
    def test_indicator_creates_score_columns_with_expected_ranges(self):
        ...
        indicator = NeuralEmaLowAdxSetupQualityV4BG020(symbol)
